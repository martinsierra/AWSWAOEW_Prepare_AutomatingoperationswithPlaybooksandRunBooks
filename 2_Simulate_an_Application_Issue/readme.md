...
![Section3 Base Architecture](/2_Simulate_an_Application_Issue/section3-testing-canary-alarm-architecture.png)
...
1. From the **Cloud Shell** terminal, run the command shown below to change directory to the working script folder:
...
![Section3 Succces Screenshot](/2_Simulate_an_Application_Issue/section3-stackoutput.png)
...
![Section3 Succces Screenshot](/2_Simulate_an_Application_Issue/section3-success-traffic-requests.png)

![Section3 Failure Screenshot](/2_Simulate_an_Application_Issue/section3-failure-traffic-requests.png)
...
![Section3 Email](/2_Simulate_an_Application_Issue/section3-email.png)

2. Check and confirm the alarm by going to the CloudWatch console.

3. Choose the Alarms section on the left menu.

4. Choose the Alarms called mysecretword-canary-duration-alarm, which should be in an alarm state.

![Section3 Failure Screenshot](/2_Simulate_an_Application_Issue/section3-alarm.png)

5. Choose the alarm to display the CloudWatch metrics that the alarm data is based from.
...
![Section3 Failure Screenshot](/2_Simulate_an_Application_Issue/section3-alarm-detail.png)

8. On the left menu click on Synthetics and locate the canary monitor named mysecretword-canary.

![Section3 Canary](/2_Simulate_an_Application_Issue/section3-canary.png)

9. Choose the canary and the select the **Configuration** tab.
...
![Section3 Canary](/2_Simulate_an_Application_Issue/section3-canary-detail.png)

12. Choose the **Monitoring** tab.
...
![Section3 Canary](/2_Simulate_an_Application_Issue/section3-canary-monitor.png)
